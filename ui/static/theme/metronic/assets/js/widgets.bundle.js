...
var KTCardsWidget6 = function () {
    ...
    var initChart = function() {
        ...
        var datosGraficoEgresos = JSON.parse(document.getElementById("graficoEgresos").value);
        var labelGraficoEgresos = document.getElementById("labelGraficoEgresos").value;
        var height = parseInt(KTUtil.css(element, 'height'));
        var labelColor = KTUtil.getCssVariableValue('--kt-gray-500');
        var borderColor = KTUtil.getCssVariableValue('--kt-border-dashed-color');
            ...
            tooltip: {
                ...
                x: {
                    formatter: function (val) {
                        ...
                        var new_date = moment(startdate, "DD-MM-YYYY").add(val, 'days');
                        return new_date.format('D MMM');
                    }
                },
                y: {
                    formatter: function (val) {
    ...
    var initChart = function() {
        ...
        var options = {
            series: [{
                ...
                name: 'Unsubscribede',
                data: [18, 15, -5, -20, -30, -15, -10, -8, -5, -5, -10, -25, -15, -5, -10, -5, -15]
            }],
            chart: {
                fontFamily: 'inherit',
                type: 'bar',
            ...
            xaxis: {
                categories: ['Jan 1', 'Jan 7', 'Jan 9', 'Jan 11', 'Jan 13', 'Jan 15', 'Jan 17', 'Jan 19', 'Jan 20', 'Jan 21', 'Jan 23', 'Jan 24', 'Jan 25', 'Jan 26', 'Jan 24', 'Jan 28', 'Jan 29'],
                axisBorder: {
                    show: false
                },
                axisTicks: {
...
var KTChartsWidget22 = function () {
    ...
    var initChart = function(tabSelector, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            labels: ['empresa 1', 'empresa 2', 'empresa 3', 'empresa4'],
            legend: {
                show: false,
            },
            fill: {
...
var KTChartsWidget3 = function () {
    ...
    var initChart = function(chart) {
        ...
        var x_ch_aux = document.getElementById("x_flujo_caja_chart").value;
        var x_ch = JSON.parse(x_ch_aux.replace(/'/g, '"'));
        var y_ch1 = JSON.parse(document.getElementById("y_flujo_caja_chart1").value);
        var y_ch2 = JSON.parse(document.getElementById("y_flujo_caja_chart2").value);
        var x_test = JSON.parse(document.getElementById("x_flujo_test").value);
        var max_fc = parseInt(document.getElementById("max_fc").value);
        var min_fc = parseInt(document.getElementById("min_fc").value);
        ...
        var borderColor = KTUtil.getCssVariableValue('--kt-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--kt-success');
        var baseColor2 = KTUtil.getCssVariableValue('--kt-info');
        var lightColor = KTUtil.getCssVariableValue('--kt-success');
        ...
        var options = {
            ...
            yaxis: {
                ...
                labels: {
                    ...
                    formatter: function (val) {
                        // todo formatter according to amount, enviar conversion y letra desde backend
