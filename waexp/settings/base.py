...
RINDEGASTOS_FUNDS_ADMIN_ID = os.environ.get("RINDEGASTOS_FUNDS_ADMIN_ID", "").strip()
FUNDS_RINDEGASTOS_CACHE_TIMEOUT_SECONDS = int(
    os.environ.get("FUNDS_RINDEGASTOS_CACHE_TIMEOUT_SECONDS", str(24 * 60 * 60))
)
FUNDS_DEPOSIT_AUDIT_TRANSACTION_SNAPSHOT_LIMIT = int(
    os.environ.get("FUNDS_DEPOSIT_AUDIT_TRANSACTION_SNAPSHOT_LIMIT", "50")
)
FUNDS_DEPOSIT_POST_VERIFY_ATTEMPTS = int(os.environ.get("FUNDS_DEPOSIT_POST_VERIFY_ATTEMPTS", "4"))
FUNDS_DEPOSIT_POST_VERIFY_SLEEP_SECONDS = float(os.environ.get("FUNDS_DEPOSIT_POST_VERIFY_SLEEP_SECONDS", "1"))
FUNDS_DEPOSIT_ALLOWED_USER_EMAILS = env_list("FUNDS_DEPOSIT_ALLOWED_USER_EMAILS") or ["fsantibanez@otzi.cl"]
...
NOTION_FUNDS_SYNCED_STATUS_VALUE = os.environ.get(
    "NOTION_FUNDS_SYNCED_STATUS_VALUE",
    "Transferido y sincronizado",
).strip()
