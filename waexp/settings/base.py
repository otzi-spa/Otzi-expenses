...
NOTION_FUNDS_AMOUNT_PROPERTY = os.environ.get("NOTION_FUNDS_AMOUNT_PROPERTY", "Monto").strip()
...
NOTION_FUNDS_REMITTANCE_PROPERTY = os.environ.get("NOTION_FUNDS_REMITTANCE_PROPERTY", "N ID").strip()
NOTION_FUNDS_COST_CENTER_PROPERTY = os.environ.get("NOTION_FUNDS_COST_CENTER_PROPERTY", "Centro de costo").strip()
FUNDS_ALLOWED_USER_EMAILS = env_list("FUNDS_ALLOWED_USER_EMAILS") or ["fsantibanez@otzi.cl"]
